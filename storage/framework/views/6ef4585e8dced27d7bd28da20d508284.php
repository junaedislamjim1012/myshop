...
if (typeof fbq === 'function') {
    fbq('track', 'ViewContent', {
        ...
        value: <?php echo e($details->new_price ?? 0); ?>,
        currency: 'BDT'
    }, { eventID: '<?php echo e($vc_event_id ?? "vc_prod_".$details->id."_".time()); ?>' });
}
            ...
            try {
                ...
                if (data && data.success) {
                    ...
                    if (data.redirect || isOrderNow) {
                        window.location.href = data.redirect || "<?php echo e(route('customer.checkout')); ?>";
                    } else {
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/myshop3.creativedesign.com.bd/resources/views/frontEnd/layouts/pages/details.blade.php ENDPATH**/ ?>