...
window.dataLayer.push({
    ...
    ecommerce: {
        currency: 'BDT',
        value: <?php echo e($checkoutValue); ?>,
...
if (typeof fbq === 'function') {
    fbq('track', 'InitiateCheckout', {
        value: <?php echo e($checkoutValue); ?>,
        currency: 'BDT',
        num_items: <?php echo e(count($cartItems)); ?>,
        content_ids: <?php echo json_encode($contentIds, 15, 512) ?>,
...
if (typeof ttq !== 'undefined') {
    ttq.track('InitiateCheckout', {
        value: <?php echo e($checkoutValue); ?>,
        currency: 'BDT',
        contents: <?php echo json_encode($tiktokContents, 15, 512) ?>,
        content_type: 'product'
    });
}
<?php $__env->stopPush(); ?>
    ...
    $(document).ready(function() {
        ...
        $('#area').on('change', function () {
            ...
            if (isFreeDelivery) {
                ...
                $.get('<?php echo e(route("shipping.charge")); ?>', { id: $(this).val() });
            }
        ...
        function saveIncompleteOrderSync() {
            ...
            navigator.sendBeacon('<?php echo e(route("incomplete.order.store")); ?>', new Blob([payload], {type: 'application/json'}));
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>