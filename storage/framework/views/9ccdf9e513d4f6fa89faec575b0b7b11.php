...
.parsley-error {
    border: 1px solid <?php echo e($generalsetting->primary_color); ?> !important;
}
...
.footer-top {
    padding: 50px 0;
    background: <?php echo e($generalsetting->footer_color ?? '#1a1a1a'); ?>;
    background-color: <?php echo e($generalsetting->footer_color ?? '#1a1a1a'); ?>;
}
...
.footer-bottom {
    background: <?php echo e($generalsetting->copyright_color ?? '#000000'); ?>;
    background-color: <?php echo e($generalsetting->copyright_color ?? '#000000'); ?>;
    padding: 10px 0;
}
...
.details-action-box .empty-content i {
    ...
    text-align: center;
    line-height: 80px;
    background-color: <?php echo e($generalsetting->primary_color); ?>33;
    border-radius: 50%;
    color: <?php echo e($generalsetting->primary_color); ?>;
}
...
.cust_according_body ul li:hover a {
    background-color: <?php echo e($generalsetting->primary_color); ?>38;
}
...
.custom-loader {
    width: 50px;
    height: 50px;
    --c: radial-gradient(farthest-side, <?php echo e($generalsetting->primary_color); ?> 92%, #0000);
...
.menu-more {
    color: <?php echo e($generalsetting->primary_color); ?> !important;
    font-weight: 600;
}
...
<?php /**PATH /home/creativedesignbd/ecommerce3.creativedesign.com.bd/resources/views/frontEnd/assets/style.blade.php ENDPATH**/ ?>